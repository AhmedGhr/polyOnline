...
else {           $error="error d'ajout de prof , essayer de nouveau";
}
}
?>
...
<div class="col-sm-4">
<input type="text" class="form-control" name="nompr" placeholder="Nom et prénom" value="" required>
</div>

<label class="col-sm-2 control-label">Telephone<span style="color:red">*</span></label >
<div class="col-sm-4">
<input type="number" class="form-control" name="tel" placeholder="Numero telephone" required>

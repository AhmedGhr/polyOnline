			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Page des TDs</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Liste des TDs</div>
...
$sql="SELECT *  FROM matiere where type='TD' ";
...
<a href="td_page.php?file_id=<?php echo $row['id'];?>" onclick="return confirm('Do you want to telecharger');">&nbsp; <i class="fa fa-download"></i></a>&nbsp;&nbsp;
...
<input type="file" name="myfile" value="ajouter" />

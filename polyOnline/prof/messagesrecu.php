...
if(mysqli_num_rows($res) > 0) 
{
	...
	$emailetudiant=$row['sender'];
	$sql2 = "SELECT * from  etudiant where email='$emailetudiant'";
	$res2=mysqli_query($connect,$sql2);
	$row2 = mysqli_fetch_assoc($res2);
{							?>	
										<tr class="text-center">
											<td><?php echo htmlentities($cnt);?></td>
											<td><img src="/polyOnline/etudiant/images/<?php echo $row2['image'];?>" style="width:60px; border-radius:50%;"/></td>
											...
											<td>
<a href="sendreply.php?reply=<?php echo $emailetudiant;?>&id=<?php echo $row['id'];?>">&nbsp; <i class="fa fa-mail-reply"></i></a>&nbsp;&nbsp;
<a href="messagesrecu.php?del=<?php echo $row['id'];?>" onclick="return confirm('Voulez vous vraiment supprimer ce message?');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;

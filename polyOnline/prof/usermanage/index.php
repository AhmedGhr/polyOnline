...
<body>
	<div class="login-page bk-img">
		<div class="form-content">
			<div class="container">
				<div class="row">
				<i class="fa fa-arrow-left" aria-hidden="true"></i>&emsp;<a href="../pfe1/index.php">Retour vers l'accueil</a>
                        <img src="hsorigine.png"style="height:200px;width:180px; margin-left:330px" />
					<div class="col-md-6 col-md-offset-3">
					
						<h1 class="text-center text-bold mt-4x">Authentification</h1>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">
									...
									<label for="" class="text-uppercase text-sm">Votre mot de passe</label>
